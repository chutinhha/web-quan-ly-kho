...
{
    public partial class DanhSachKeHoach : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e) 
        {
            ...
            if (e.CommandName.ToString() == "PheDuyet")
            {
                ...
                if (GridView1.DataKeys[index].Value.ToString() != "")
                {
                    ...
                    string window = "../QLKho/ChiTietKeHoach.aspx";
        ...
        public void BindData()
        {
            ...
            cmd.CommandText += " order by ngaylap";
