<%@ Page Language="C#" MasterPageFile="~/master/default_pop.master" AutoEventWireup="true" CodeBehind="popPheDuyetKeHoach.aspx.cs" Inherits="QLCV.QLKho.popPheDuyetKeHoach" %>
                        ...
                        <td align="center" valign = "top">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 99%;">
                                ...
                                <td colspan=4 align=center>
                                 <asp:Label ID="lblCanhBao" runat="server" Height="22px"      
                                                         Font-Bold="True" Font-Names="Arial" ForeColor="blue" Font-Size= "Small"></asp:Label>
                                </td>
                                </tr>
                                <tr>
                                        <td colspan=4>THÔNG TIN TỔNG HỢP</td>
                                        </tr>
                                      <tr align="left">
                            ...
                            <Columns>
                                    ...
                                    <!--hết grid detail-->
                                        ...
                                        <asp:Button ID="btnGhi" runat="server" Text="Phê duyệt" OnClick="btnGhi_Click" Width=100px Font-Bold="true"  ForeColor="Teal" />
                                        <asp:Button ID="btnKhongDuyet" runat="server" Text="Không phê duyệt" OnClick="btnKhongPheDuyet_Click" Width=130px Font-Bold="true"  ForeColor="Teal" />
