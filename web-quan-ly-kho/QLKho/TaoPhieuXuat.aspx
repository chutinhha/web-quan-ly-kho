<%@ Page Language="C#" MasterPageFile="~/master/default_pop.master" AutoEventWireup="true" CodeBehind="TaoPhieuXuat.aspx.cs" Inherits="QLCV.QLKho.TaoPhieuXuat" %>
                        ...
                        <td align="center" valign = "top">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 99%;">
                                ...
                                <td><br /></td>
                                       ...
                                       <td colspan=4>
                                        ...
                                        <td style="width:12%;">Kiểu xuất</td>
                                        <td style="width:20%;">
                                        ...
                                        <td>
                                        <asp:DropDownList ID="cboNhanVienDoiTac"   DataTextField="TenNhanVien" DataValueField="DoiTac_NhanVien_Id" runat="server" Height="20px" 
                                                Width="230px">
                                        ...
                                        <asp:Button ID="btnGhi" runat="server" Text="Tạo phiếu xuất" OnClick="btnGhi_Click" Width=120px Font-Bold="true"  ForeColor="Teal" />
                            ...
                            <Columns>
                                          ...
                                          <asp:TemplateField HeaderText="Số lượng tồn">
                                            ...
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUSoLuongTon" Enabled=false Text='<%#Bind("sl_tonck")%>' MaxLength="10" runat="server" Width="50"/>
                                    ...
                                    <!--hết grid detail-->
                                                ...
                                                <td><br /></td>
                                                 ...
                                                 <tr><td style="background-color: #009900; ">DANH SÁCH PHIẾU XUẤT</td></tr>
                                                <!--grid-->
                                                <asp:GridView ID="GridView1" runat="server"  
                                                     AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="false" AutoGenerateColumns="false"
                                                      ...
                                                      <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Ngày nhập" DataField="Ngay_Xuat" />  
                                                        <asp:BoundField HeaderText="Lý do" DataField="LyDoXuat" />  
