<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="HoanThienPhieuNhap.aspx.cs" Inherits="QLCV.DanhMuc.HoanThienPhieuNhap" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">HOÀN THIỆN PHIẾU NHẬP
						</td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 99%;">
                                <tr>
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Hoàn thiện phiếu nhập</b>
                                 ...
                                 <tr>
                                         ...
                                         <td colspan=2 style="background-color: #009900; font-size:14; " align="left" 
                                                 bgcolor="#339933">Lựa chọn phiếu nhập</td>
                                        <td colspan=2 style="background-color: #009900; " align="right" bgcolor="#339933" >
                                        <asp:Button ID="Button1" runat="server" Text="Lọc phiếu" OnClick="btnLocPhieu_Click" Width=120px Font-Bold="true"  ForeColor="Teal" />
                                ...
                                <asp:DropDownList ID="cboDoiTuongGiaoHang"  DataTextField="Code" DataValueField="DoiTuongGiaoHang_id" runat="server" Height="20px" 
                                 ...
                                 <tr>
                                         ...
                                         <tr>
                                         <td colspan=2 style="background-color: #009900; font-size:14; " align="left">Lựa chọn phiếu nhập</td>
                                                ...
                                                <asp:GridView ID="GridView1" runat="server"  Caption=""
                                                     AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="false" AutoGenerateColumns="false"
                                                      ...
                                                      <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="Lý do nhập" DataField="LyDoNhap" />  
