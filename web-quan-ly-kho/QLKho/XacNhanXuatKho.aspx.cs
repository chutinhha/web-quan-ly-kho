...
{
    public partial class XacNhanXuatKho : System.Web.UI.Page
    {
        ...
        public void BindData()
        {
            ...
            cmd.CommandText = "select a.PhieuXuat_Id,a.So_Phieu,convert(nvarchar(10),a.Ngay_Xuat,103) Ngay_Nhap,a.LyDoXuat,a.Dien_Giai from PhieuXuat a where 1=1 ";
            if (dtpTuNgay.SelectedDate.ToString().Length > 0 && dtpDenNgay.SelectedDate.ToString().Length > 0)
            {
                cmd.CommandText += " and convert(nvarchar(8),a.Ngay_Xuat,112)>='" + dtpTuNgay.SelectedDate.Value.ToString("yyyyMMdd") + "' and convert(nvarchar(8),a.Ngay_Xuat,112)<='" + dtpDenNgay.SelectedDate.Value.ToString("yyyyMMdd") + "'";
            }
            if (txtSoPhieu.Text != "")
            {
            ...
            {
                cmd.CommandText += " and a.NhanVien_Xuat_Id='" + cboDoiTuongGiaoHang.SelectedValue.ToString() + "'";
            }
            ...
            {
                cmd.CommandText += " and a.NhanVien_DoiTac_Id='" + cboDoiTuongGiaoHang.SelectedValue.ToString() + "'";
            }
            if (txtNguoiLap.Text != "")
            {
                cmd.CommandText += " and a.NguoiXuat=N'" + txtNguoiLap.Text +"'";
            }
