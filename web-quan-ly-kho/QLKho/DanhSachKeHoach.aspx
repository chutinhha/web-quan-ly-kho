<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="DanhSachKeHoach.aspx.cs" Inherits="QLCV.QLKho.DanhSachKeHoach" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH SÁCH KẾ HOẠCH
						</td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 99%;">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh sách kế hoạch</b>
                                ...
                                <tr>
                                    <td>
                                       ...
                                       <td>Tình trạng</td>
                                       <td>
                                       <asp:DropDownList ID="cboTinhTrang"  DataTextField="TinhTrang" DataValueField="TinhTrang_id" runat="server" Height="20px" 
                                                Width="230px">
                                            </asp:DropDownList>  
                                       </td>
                                       <td align=left>
