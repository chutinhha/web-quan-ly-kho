<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="XuatKho.aspx.cs" Inherits="QLCV.DanhMuc.XuatKho" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">XUẤT KHO
						</td>
                        ...
                        <td align="center" valign = "top">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 99%;">
                                <tr>
                                 ...
                                 <tr>
                                        ...
                                        <asp:Button ID="Button1" runat="server" Text="Tạo phiếu xuất" OnClick="btnTaoPhieuNhap_Click" Width=120px Font-Bold="true"  ForeColor="Teal" />
                            ...
                            <Columns>
                                ...
                                <tr>
                                         ...
                                         <tr>
                                        <td colspan=4 style="background-color: #009900; " align="right" >
                                        <asp:Button ID="btnTaoPhieuNhap" runat="server" Text="Tạo phiếu xuất" OnClick="btnTaoPhieuNhap_Click" Width=120px Font-Bold="true"  ForeColor="Teal" /> 
                                        </td>
                                         </tr>
                                         </table>
                                         </td>
                                ...
                                <tr>
                                        <td colspan=6>DANH SÁCH KẾ HOẠCH XUẤT</td>
                                        </tr>
                                        <tr>
                                        <td colspan=6>
