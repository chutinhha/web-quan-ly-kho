<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="NhaCungCap.aspx.cs" Inherits="QLCV.DanhMuc.NhaCungCap" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH MỤC NHÀ CUNG CẤP
						</td>
                        ...
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục nhà cung cấp</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="NhaCungCap_Id" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên nhà cung cấp">
                                            ...
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUIndex" Enabled=true Text='<%#Bind("TenNCC")%>' MaxLength="100" runat="server"/>
                                          ...
                                          <asp:TemplateField HeaderText="Email">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUEmail" Text='<%#Bind("Email")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIEmail" runat="server" MaxLength="100"></asp:TextBox><br />
