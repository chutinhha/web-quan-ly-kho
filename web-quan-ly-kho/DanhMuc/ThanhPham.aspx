<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="ThanhPham.aspx.cs" Inherits="QLCV.DanhMuc.ThanhPham" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH MỤC THÀNH PHẨM
						</td>
                        ...
                        <td align="center" valign = "top">
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="ThanhPham_id" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên thành phẩm">
                                            ...
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUTenThanhPham" Enabled=true Text='<%#Bind("TenThanhPham")%>' MaxLength="100" runat="server"/>
    				
                                            </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtITenThanhPham" Enabled=true runat="server" MaxLength="100"></asp:TextBox>
    						                </FooterTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Alias Name">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUAliasName" Text='<%#Bind("AliasName")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIAliasName" runat="server" MaxLength="100"></asp:TextBox><br />
                                           ...
                                           <asp:TemplateField HeaderText="Diễn giải">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUDienGiai" Text='<%#Bind("DienGiai")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIDienGiai" runat="server" MaxLength="100"></asp:TextBox><br />
	    						                   <asp:RequiredFieldValidator ID="RetelDetail" runat="server" ControlToValidate="txtIDienGiai" Display="Dynamic" ErrorMessage="Nhập diễn giải" SetFocusOnError="True"></asp:RequiredFieldValidator>
