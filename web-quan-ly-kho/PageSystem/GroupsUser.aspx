<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="GroupsUser.aspx.cs" Inherits="QLCV.PageSystem.GroupsUser" %>
                        ...
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục Nhóm người dùng</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="GroupId" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên nhóm">
                                            ...
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUIndex" Enabled=true Text='<%#Bind("GroupName")%>' MaxLength="100" runat="server"/>
                                          ...
                                          <asp:TemplateField HeaderText="Mô tả">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUEthnic" Text='<%#Bind("Detail")%>' MaxLength="100" runat="server"  />
