...
TransMenu.shadowSize = 3;                              // size of shadow under menu
TransMenu.shadowOffset = 3;                            // distance shadow should be offset from leading edge
TransMenu.shadowColor = "#66CCFF";                        // color of shadow (transparency is set in CSS)
...
TransMenu.backgroundPng = "images/red-90.png";          // a PNG graphic to server as the background for mac IE5
...
function TransMenuItem(sText, sUrl, oParent) {
        ...
        function toString(bDingbat) {
                ...
                return '<tr class="item"><td height="25" nowrap style="' + sPaddingLeft + '" valign="middle">&nbsp;<font  style="font-family:Verdana; font-size:10; font-weight:normal; color=#111111">' + 
                        sText + '</font>&nbsp;&nbsp;&nbsp;</td></tr>';
        }
}
