<%@ Page Language="C#"  MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="PageReport.aspx.cs" Inherits="QLCV.N_Su.PageReport" %>
               ...
               <table style="width: 100%">
                   <tr>
                       ...
                       <td style="width: 537px">
                           <asp:DropDownList ID="cboReport" runat="server" Height="22px" Width="511px" 
                               AutoPostBack="True">
                           </asp:DropDownList>
                       </td>
