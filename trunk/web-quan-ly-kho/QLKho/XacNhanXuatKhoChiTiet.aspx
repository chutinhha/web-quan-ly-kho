<%@ Page Language="C#" MasterPageFile="~/master/default_pop.master" AutoEventWireup="true" CodeBehind="XacNhanXuatKhoChiTiet.aspx.cs" Inherits="QLCV.QLKho.XacNhanXuatKhoChiTiet" %>
                        ...
                        <td align="center" valign = "top">
                                     ...
                                     <table border="0" style="border-width: 1px; border-color:#000000;border-style: solid; width: 100%;">
                                       ...
                                       <td>
                                        <telerik:RadDatePicker ID="dtpNgayNhap" runat="server" Enabled=false
                                         ...
                                         <td align="right">Ngày xuất kho</td>
                                       <td style="width: 3px"  >
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Mã Serial">
                                            ...
                                            <EditItemTemplate>
      						                ...
      						                <FooterTemplate>
	    						                ...
	    						                <asp:LinkButton id="cmdTimKiem" runat="server" CommandName="TimKiem">Tìm kiếm</asp:LinkButton>
    						                </FooterTemplate>
                                    ...
                                    <!--hết grid detail-->
                                        ...
                                        <asp:Button ID="btnXacNhan" runat="server" Text="Xác nhận" OnClick="btnXacNhan_Click" Width=100px Font-Bold="true"  ForeColor="Teal" />
