    ...
    public partial class TaoPhieuNhap : System.Web.UI.Page
    {
        ...
        protected void btnGhi_Click(object sender, System.EventArgs e)
        {
            if (!bsua) //thêm mới
            {
                ...
                oPhieuNhap.NhanVienLogon_Id = "83e36d21-8607-4b6f-8dcc-4be0c0fd4ba5";
                oPhieuNhap.KeHoachNhapXuat_Id = sKey;
                oPhieuNhap.PhieuNhap_Id = sPhieuNhap_Id;
                oPhieuNhap.MaLoaiNhap_Id = cboMaLoaiNhap.SelectedValue;
                oPhieuNhap.LyDoNhap = txtLyDoNhap.Text;
                oPhieuNhap.Dien_Giai = txtDienGiai.Text;
                if (cboDuAn.SelectedIndex == 0)
                {
                    oPhieuNhap.DuAn_DanhRieng_Id = "";
                }
                else
                {
                    oPhieuNhap.DuAn_DanhRieng_Id = cboDuAn.SelectedValue;
                }
                oPhieuNhap.NhanVien_Mua_Id = cboNhanVienNhapXuat.SelectedValue;
                oPhieuNhap.NhanVien_DoiTac_Id = cboNhanVienDoiTac.SelectedValue;
                oPhieuNhap.ChungTu = productImage;
                oPhieuNhap.So_Phieu = txtSoPhieu.Text;
                oPhieuNhap.KieuFile = ".jpg";

                oPhieuNhap.Insert();
                lblThongBao.Text = "Tạo phiếu nhập thành công, mời bạn nhập chi tiết";
            }
            else //sửa
            {
        ...
        private void bindData(int index)
        {
            try
            {
                ...
                objPhieuNhapChiTiet.KeHoachNhapXuat_Id = sKey;
