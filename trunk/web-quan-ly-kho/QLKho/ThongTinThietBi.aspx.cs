...
{
    public partial class ThongTinThietBi : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HttpCookie Cookie = Request.Cookies["PhieuNhapID"];
            txtPhieuNhapID.Text = Cookie["Data"];
        }
        ...
        private void bindData(int index)
        {
            try
            {
                ...
                clsThongTinThietBi objThongTinThietBi= new clsThongTinThietBi();
                dsGroup = objThongTinThietBi.Select();
                objThongTinThietBi.ThongTinThietBi_Id = "0";
