...
namespace QLCV.code.common
{
    ...
    {
        public static string FormatNumber(string StrNumber, byte NumDot, string NumSpace , string NumComma )
{
	string[] StrArr = null;
	...
	return StrFormat;
        ...
        /// <returns></returns>
        public static string NumberToText(double Number1, string sNgoaiTe)
        {
        ...
        public static void ToUpperFirstLetter(ref string sSource)
        {
            string str1 = null;
            string str2 = null;
   ...
   public static float StrToFloat( string StrNumber)
{
            ...
            try
            {
                return Convert.ToSingle(StrNumber);
            }
            catch
            {
                return 0;
