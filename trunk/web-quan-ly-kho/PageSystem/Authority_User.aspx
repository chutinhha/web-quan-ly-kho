<%@ Page Language="C#"  MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="Authority_User.aspx.cs" Inherits="QLCV.PageSystem.Authority_User" %>
   ...
   <ContentTemplate>
          ...
          <table style="width: 100%">
              <tr>
                      ...
                      <table style="width: 100%">
                          <tr>
                              <td style ="width: 10%; font-size: small;"> 
                                  <b>Nhóm:</b></td>
                              <td style="width: 80%">
                                  <telerik:RadComboBox ID="cboGroup" Runat="server" Height="200px" Width="100%" 
                  ...
                  <td style="height: 22px; text-align: center; width: 415px; font-size: small;">
                      <b>Chức năng</b></td>
              ...
              <tr>
                      ...
                      <telerik:RadGrid ID="gridGroup" runat="server" GridLines="None" Height="477px" 
                          ...
                          <MasterTableView DataKeyNames="ID">
                              ...
                              <Columns>
                                  ...
                                  <telerik:GridBoundColumn DataField="Department" HeaderText="Bộ phận" 
                  ...
                  <td style="height: 464px; width: 415px">
                  ...
                  <td style="width: 18px; height: 464px">
                  </td>
