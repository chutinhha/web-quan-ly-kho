...
function AVIM() {
    ...
    this.doSetCookie = function() {
        ...
        try {
            document.cookie = 'AVIM_on_off=' + AVIMGlobalConfig.onOff + ';path=/;domain=go.vn;expires=' + exp;
            document.cookie = 'AVIM_method=' + AVIMGlobalConfig.method + ';path=/;domain=go.vn;expires=' + exp;
            document.cookie = 'AVIM_ckspell=' + AVIMGlobalConfig.ckSpell + ';path=/;domain=go.vn;expires=' + exp;
            document.cookie = 'AVIM_daucu=' + AVIMGlobalConfig.oldAccent + ';path=/;domain=go.vn;expires=' + exp;
        }
        catch (Error)
        { }
    }
