...
auxImg1 = new Image();
alert(ICONPATH);
auxImg1.src = ICONPATH + "ftv2vertline.gif";
auxImg2 = new Image();
auxImg2.src = ICONPATH + "ftv2mlastnode.gif";
auxImg3 = new Image();
auxImg3.src = ICONPATH + "ftv2mnode.gif";
auxImg4 = new Image();
auxImg4.src = ICONPATH + "ftv2plastnode.gif";
auxImg5 = new Image();
auxImg5.src = ICONPATH + "ftv2pnode.gif";
auxImg6 = new Image();
auxImg6.src = ICONPATH + "ftv2blank.gif";
auxImg7 = new Image();
auxImg7.src = ICONPATH + "ftv2lastnode.gif";
auxImg8 = new Image();
auxImg8.src = ICONPATH + "ftv2node.gif";
auxImg9 = new Image();
auxImg9.src = ICONPATH + "ftv2folderclosed.gif";
auxImg10 = new Image();
auxImg10.src = ICONPATH + "ftv2folderopen.gif";
auxImg11 = new Image();
auxImg11.src = ICONPATH + "ftv2doc.gif";
}
