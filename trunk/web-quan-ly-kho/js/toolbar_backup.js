...
if (ToolBar_Supported)
{
	...
	if (!RTL){
		...
		HTMLStr += "<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0px;left:100px;height:20px;width:18px;overflow:hidden;vertical-align:top;'><IMG SRC='/SMSReports/images/curve.gif' BORDER=0></DIV>";
		HTMLStr += "<DIV ID='idMSMenuPane'  STYLE='position:absolute;top:0px;left:100px;height:20px;width:10px;background-color:black;float:right;' NOWRAP><!--MS_MENU_TITLES--></DIV>";
		HTMLStr += "</DIV>";
	}else if(RTL){
		...
		HTMLStr += "<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:100;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='/SMSReports/images/curve.gif' BORDER=0></DIV>";
		// RTL Correction: added: dir='ltr' (forcing LTR!), added: &nbsp; (prevents last menu problem)
		HTMLStr += "<DIV dir='ltr' lang='he' ID='idMSMenuPane'  STYLE='position:absolute;top:0;left:100;height:20;width:10;color:white;background-color:black;float:left;' NOWRAP><!--MS_MENU_TITLES-->&nbsp;</DIV>";
		HTMLStr += "</DIV>";
	}
	if(!RTL){
		HTMLStr += "<DIV ID='idRow2' STYLE='position:relative;left:100px;height:40px;'>";
	...
	//ToolbarBGColor	= "#5b88c2";						// toolbar background color
	ToolbarBGColor	= "#0055a5"// "#0758a7";						// toolbar background color
	...
	//aDefICPColor[0]	= aCurICPColor[0] = "#fe0006";	// bgcolor;#fe0006
...
function addICPMenu(MenuIDStr, MenuDisplayStr, MenuHelpStr, MenuURLStr, Popup)
{ 	
	if(RTL){
