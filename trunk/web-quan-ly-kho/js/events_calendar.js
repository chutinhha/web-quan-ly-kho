...
function drawDayEvent() {
    if (eventSource != null) {
        $.each(eventSource, function (i, result) {
            $("#evxDay" + formatJsonSimple(result.StartDate)).append('<tr><td width="100%" valign="top"><img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a></td></tr>');
    ...
    if (eventSource != null) {
        $.each(eventSource, function (i, result) {
            ...
            if (dtStart < new Date("2011/10/10 7:00")) {
                $("#eventH6").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 7:00") && dtStart < new Date("2011/10/10 8:00")) {
                $("#eventH7").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 8:00") && dtStart < new Date("2011/10/10 9:00")) {
                $("#eventH8").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 9:00") && dtStart < new Date("2011/10/10 10:00")) {
                $("#eventH9").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 10:00") && dtStart < new Date("2011/10/10 11:00")) {
                $("#eventH10").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 11:00") && dtStart < new Date("2011/10/10 12:00")) {
                $("#eventH11").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 12:00") && dtStart < new Date("2011/10/10 13:00")) {
                $("#eventH12").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 13:00") && dtStart < new Date("2011/10/10 14:00")) {
                $("#eventH13").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 14:00") && dtStart < new Date("2011/10/10 15:00")) {
                $("#eventH14").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 15:00") && dtStart < new Date("2011/10/10 16:00")) {
                $("#eventH15").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 16:00") && dtStart < new Date("2011/10/10 17:00")) {
                $("#eventH16").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            else if (dtStart >= new Date("2011/10/10 17:00")) {
                $("#eventH17").append('<img id="imgApproved' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"><img id="imgRejected' + result.Id + '" style="display:none" border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"><a id="lnkViewId' + result.Id + '" href="javascript:;" onclick="viewEventDetail(' + result.Id + ')">' + formatDateTime(result.StartDate) + ' ' + result.Title + '</a><br />');
            }
            if (result.Status == 2) {
                $("#imgApproved" + result.Id).attr("style", "");
            }
...
function drawCalendar(currDate, duration) {
    ...
    if (xhrWorkSource != undefined) xhrWorkSource.abort();
    xhrWorkSource = $.ajax({
        type: 'GET',
        url: urlRoot + "Handlers/CalendarEventsHandler.ashx?handler=getworklist" + "&duration=" + duration + "&date=" + currDate + "&userId=" + userId,
        processData: true,
        dataType: "json",
        cache: false,
    ...
    xhrEventSource = $.ajax({
        type: 'GET',
        url: urlRoot + "Handlers/CalendarEventsHandler.ashx?handler=getlist" + "&duration=" + duration + "&date=" + currDate + "&userId=" + userId,
        processData: true,
        dataType: "json",
        cache: false,
        success: function (data) {
            ...
            if (data != null) {
                ...
                $.each(data.Members, function (i, result) {
                    ...
                    if (result.Status == 1) {
                        ...
                        divDetailContent += '<img border="0" align="absmiddle" title="Đã chấp nhận" src="' + urlRoot + 'images/icon_approved.gif"> Chấp nhận';
                    }
                    else if (result.Status == 3) {
                        divDetailContent += '<img border="0" align="absmiddle" title="Đã từ chối" src="' + urlRoot + 'images/icon_rejected.gif"> Từ chối';
                    }
                    else if (result.Status == 4) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data != null) {
                ...
                divDetailContent += '</tr>';
                divDetailContent += '<tr>';
                divDetailContent += '<td width="100%" class="FormSubject" colspan="3"><a id="expand' + data[0].DepartmentID + '" href="javascript:;" onclick="expandDepartment(' + data[0].DepartmentID + ')"><img border="0" align="absmiddle" src="' + urlRoot + 'images/m_plus.gif" id="imgSessionD"></a><a id="collapse' + data[0].DepartmentID + '" style="display: none" href="javascript:;" onclick="collapseDepartment(' + data[0].DepartmentID + ')"><img border="0" align="absmiddle" src="' + urlRoot + 'images/m_minus.gif" id="imgSessionD"></a> ' + data[0].DepartmentName + '</td>';
                divDetailContent += '</tr>';
                $.each(data, function (i, result) {
                    if (departmentID != result.DepartmentID) {
                        divDetailContent += '<tr>';
                        divDetailContent += '<td width="100%" class="FormSubject" colspan="3"><a id="expand' + result.DepartmentID + '" href="javascript:;" onclick="expandDepartment(' + result.DepartmentID + ')"><img border="0" align="absmiddle" src="' + urlRoot + 'images/m_plus.gif" id="imgSessionD"></a><a id="collapse' + result.DepartmentID + '" style="display: none" href="javascript:;" onclick="collapseDepartment(' + result.DepartmentID + ')"><img border="0" align="absmiddle" src="' + urlRoot + 'images/m_minus.gif" id="imgSessionD"></a> ' + result.DepartmentName + '</td>';
                        divDetailContent += '</tr>';
