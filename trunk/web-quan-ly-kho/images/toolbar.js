...
if (ToolBar_Supported)
{
	...
	if (!RTL){
		...
		HTMLStr += "<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0px;left:100px;height:20px;width:18px;overflow:hidden;vertical-align:top;'><IMG SRC='/Report/images/curve.gif' BORDER=0></DIV>";
		...
		HTMLStr += "<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:100;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='/Report/images/curve.gif' BORDER=0></DIV>";
