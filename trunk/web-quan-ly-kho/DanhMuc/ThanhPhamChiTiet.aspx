<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="ThanhPhamChiTiet.aspx.cs" Inherits="QLCV.DanhMuc.ThanhPhamChiTiet" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH MỤC THÀNH PHẨM CHI TIẾT
						</td>
                        ...
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục thành phẩm</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="ThanhPhamChiTiet_id" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên thành phẩm">
                                            ...
                                            <EditItemTemplate>
                                               <asp:DropDownList ID="txtUThanhPham" DataSource='<%# GetSourceThanhPham() %>' DataTextField="TenThanhPham" DataValueField="ThanhPham_Id" MaxLength="100" runat="server"/></asp:DropDownList>
    				
                                            </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:DropDownList id="txtIThanhPham" DataSource='<%# GetSourceThanhPham() %>' DataTextField="TenThanhPham" DataValueField="ThanhPham_Id" runat="server" MaxLength="100"></asp:DropDownList>
    						                </FooterTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Tên thiết bị">
                                            ...
                                            <EditItemTemplate>
                                              <asp:DropDownList ID="txtUThietBi" DataSource='<%# GetSourceThietBi() %>' DataTextField="TenThietBi" DataValueField="ThietBi_Id" MaxLength="100" runat="server"  /></asp:DropDownList>
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:DropDownList id="txtIThietBi" runat="server" DataSource='<%# GetSourceThietBi() %>' DataTextField="TenThietBi" DataValueField="ThietBi_Id" MaxLength="100"></asp:DropDownList><br />
