<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="LoaiTbi.aspx.cs" Inherits="QLCV.DanhMuc.LoaiTbi" %>
    ...
    <table style="width: 100%;height:100% " cellpadding="0" cellspacing="0" border="0">
                    <tr valign="top" style ="width: 100%;">
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục loại thiết bị</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="LoaiThietBi_Id" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên loại tbi">
                                            <ItemTemplate>
                                              <%#Eval("TenLoaiThietBi")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUTenLoaiThietBi" Enabled=true Text='<%#Bind("TenLoaiThietBi")%>' MaxLength="100" runat="server"/>
    				
                                            </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtITenLoaiThietBi" Enabled=true runat="server" MaxLength="100"></asp:TextBox>
    						                </FooterTemplate>
