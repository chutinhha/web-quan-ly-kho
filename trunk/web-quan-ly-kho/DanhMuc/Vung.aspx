<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="Vung.aspx.cs" Inherits="QLCV.DanhMuc.Vung" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH MỤC VÙNG MIỀN
						</td>
    ...
    <table style="width: 100%;height:100% " cellpadding="0" cellspacing="0" border="0">
                    <tr valign="top" style ="width: 100%;">
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục Vùng</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="Vung_Id" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên vùng">
                                            <ItemTemplate>
                                              <%#Eval("TenVung")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUTenVung" Enabled=true Text='<%#Bind("TenVung")%>' MaxLength="100" runat="server"/>
    				
                                            </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtITenVung" Enabled=true runat="server" MaxLength="100"></asp:TextBox>
    						                </FooterTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Alias Name">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUAlias" Text='<%#Bind("Alias")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIAlias" runat="server" MaxLength="100"></asp:TextBox><br />
