<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="Kho.aspx.cs" Inherits="QLCV.DanhMuc.Kho" %>
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH MỤC KHO
						</td>
                        ...
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục kho</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="Kho_Id" runat="server" 
                            ...
                            <Columns>
                                          <asp:TemplateField HeaderText="Tên kho">
                                            ...
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUTenKho" Enabled=true Text='<%#Bind("TenKho")%>' MaxLength="100" runat="server"/>
    				
                                            </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtITenKho" Enabled=true runat="server" MaxLength="100"></asp:TextBox>
    						                </FooterTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Nhân viên phụ trách">
                                            ...
                                            <EditItemTemplate>
                                              <asp:DropDownList ID="txtUNhanVienPhuTrach" runat="server" DataSource='<%# GetSourceNhanVien() %>' DataTextField="TenDayDu" DataValueField="NhanVien_Id" MaxLength="100" runat="server"  /></asp:DropDownList>
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:DropDownList id="txtINhanVienPhuTrach" runat="server" DataSource='<%# GetSourceNhanVien() %>' DataTextField="TenDayDu" DataValueField="NhanVien_Id" MaxLength="100"></asp:DropDownList><br />
