<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true" CodeBehind="ThietBi.aspx.cs" Inherits="QLCV.DanhMuc.ThietBi" %>

<script runat="server">
    public System.Data.SqlClient.SqlDataReader GetSourceLoaiThietBi()
    {
        ...
        string queryString = "SELECT * FROM LoaiThietBi";
		...
		<td id="maincontrol_LeftPane" width ="180" vAlign="top" height="100%" class="LeftPanel_BG" style="DISPLAY: block" >
			<Table width="180" cellpadding="0" cellspacing="0">
				<tr class="ModuleHead_Admin">
					<td class="ModuleHead" style=" width:100%"><img src="../images/NhanSu/hrm.gif" align="absMiddle" border="0" hspace="3">DANH MỤC THIẾT BỊ
						</td>
    ...
    <table style="width: 100%;height:100% " cellpadding="0" cellspacing="0" border="0">
                    <tr valign="top" style ="width: 100%;">
                        <td align="center" valign = "top">
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <font color="#3b78ae" face="Verdana" size="4">
                                                        <b style="width: 100%;">Danh mục thiết bị</b>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td align="center" valign="top">
                                                    <!--grid-->
                                                  <asp:GridView ID="m_grid" DataKeyNames="ThietBi_Id" runat="server" 
                            ...
                            <Columns>
                                        <asp:TemplateField HeaderText="Loại thiết bị">
                                            <ItemTemplate>
                                              <%#Eval("TenLoaiThietBi")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                              <asp:DropDownList ID="txtULoaiThietBi" DataSource='<%# GetSourceLoaiThietBi() %>' DataTextField="TenLoaiThietBi" DataValueField="LoaiThietBi_Id" MaxLength="100" runat="server"  /></asp:DropDownList>
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:DropDownList id="txtILoaiThietBi" runat="server" DataSource='<%# GetSourceLoaiThietBi() %>' DataTextField="TenLoaiThietBi" DataValueField="LoaiThietBi_Id" MaxLength="100"></asp:DropDownList><br />
                                          ...
                                          <asp:TemplateField HeaderText="Tên thiết bị">
                                            <ItemTemplate>
                                              <%#Eval("TenThietBi")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                               <asp:TextBox ID="txtUTenThietBi" Enabled=true Text='<%#Bind("TenThietBi")%>' MaxLength="100" runat="server"/>
    				
                                            </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtITenThietBi" Enabled=true runat="server" MaxLength="100"></asp:TextBox>
    						                </FooterTemplate>
                                            <ItemStyle HorizontalAlign="Left" />
                                          </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="Alias Name">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUAliasName" Text='<%#Bind("AliasName")%>' MaxLength="100" runat="server" Width="100" />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIAliasName" runat="server" MaxLength="100" Width="100"></asp:TextBox><br />
                                          ...
                                          <asp:TemplateField HeaderText="Cấu hình">
                                            ...
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUCauHinh" Text='<%#Bind("CauHinh")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtICauHinh" runat="server" MaxLength="100" TextMode=MultiLine Height=200px></asp:TextBox><br />
    						           
	    						                   </FooterTemplate>
                                             <ItemStyle HorizontalAlign="Left" />
                                          </asp:TemplateField>
                                          
                                          <asp:TemplateField HeaderText="Diễn giải cấu hình">
                                            <ItemTemplate>
                                              <%#Eval("DienGiai_CauHinh")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUDienGiai_CauHinh" Text='<%#Bind("DienGiai_CauHinh")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIDienGiai_CauHinh" runat="server" MaxLength="100"></asp:TextBox><br />
    						           
	    						                   </FooterTemplate>
                                             <ItemStyle HorizontalAlign="Left" />
                                          </asp:TemplateField>
                                          
                                          <asp:TemplateField HeaderText="Diễn giải cấu hình tóm tắt">
                                            <ItemTemplate>
                                              <%#Eval("DienGiai_CauHinhTomTat")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                              <asp:TextBox ID="txtUDienGiai_CauHinhTomTat" Text='<%#Bind("DienGiai_CauHinhTomTat")%>' MaxLength="100" runat="server"  />
    					
                                                                  </EditItemTemplate>
      						                <FooterTemplate>
	    						                <asp:TextBox id="txtIDienGiai_CauHinhTomTat" runat="server" MaxLength="100"></asp:TextBox><br />
    						           
	    						                   </FooterTemplate>
                                             <ItemStyle HorizontalAlign="Left" />
                                          </asp:TemplateField>
                                          
                                           <asp:TemplateField HeaderText="Đang sử dụng">
                                            <ItemTemplate>
                                              <%#Eval("IsUsing")%>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                              <asp:DropDownList ID="txtUIsUsing" runat="server"  MaxLength="100">
      						                ...
      						                <FooterTemplate>
	    						                <asp:DropDownList id="txtIIsUsing" runat="server" MaxLength="100">
    	    						                <asp:ListItem Value="0">Không sử dụng</asp:ListItem>
                                                    <asp:ListItem Value="1">Đang sử dụng</asp:ListItem>
	    						                </asp:DropDownList><br />
